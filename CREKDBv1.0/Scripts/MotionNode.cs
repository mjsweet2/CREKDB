...
public class MotionNode : Node {
    ...
    public void setInputString()
    {
        ...
        v00JSON = new NSInputJSON();
        v01JSON = new NSInputJSON();
        v02JSON = new NSInputJSON();
        v03JSON = new NSInputJSON();
        v04JSON = new NSInputJSON();

        f05JSON = new NSInputJSON();
        f06JSON = new NSInputJSON();
        f07JSON = new NSInputJSON();

        i08JSON = new NSInputJSON();
        i09JSON = new NSInputJSON();

        //the list of all the connected output used in the motion node
        inputsJSON = new NSInputsJSON();
