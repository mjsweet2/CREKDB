...
[CreateAssetMenu]
public class CRMotionGraph : NodeGraph
{


    public void exportToDB(CRMotionDBController db)
    {
    ...
    void createMotions(CRMotionDBController db)
    {
    ...
    void createFlowNodesAndEdges(CRMotionDBController db)
    {
    ...
    void connectEdges(CRMotionDBController db)
    {
        for (int i = 0; i < nodes.Count; i++)
        {
            if (nodes[i].name == "Traj")
    ...
    void connectAliases(CRMotionDBController db)
    {
        for (int i = 0; i < nodes.Count; i++)
        {
    ...
    void createFunctionNodes(CRMotionDBController db)
    {
    ...
    void createInputNodes(CRMotionDBController db)
    {
    ...
    void connectTrajInputNodes(CRMotionDBController db)
    {
        {
