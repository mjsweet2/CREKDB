...
public class NSMotionTaskItemNode : Node {

    [TextArea(1, 16)] public string nsMotionTaskItemNodeName; // this the unique container, which points to motion asset,
