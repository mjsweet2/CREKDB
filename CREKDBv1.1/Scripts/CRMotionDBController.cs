...
public class CRMotionDBController : MonoBehaviour
{
    ...
    public void insertEdgeNextNode(string edgeName, string nextNode)
    {
    ...
    public void listMotionNodes(ref List<string> records)
    {


        IDbCommand cmnd_read = dbcon.CreateCommand();
        IDataReader reader;
        string queryString = "SELECT * FROM MotionNodes";
